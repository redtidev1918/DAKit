...
## Latest version: `dakit_cli-v0.4.1` (2026-09-08)

👉 [Release notes and checksums](https://github.com/redtidev1918/DAKit/releases/tag/dakit_cli-v0.4.1)

| Platform | File | Size | Download |
|---|---|---|---|
| Linux · arm64 | `dakit-cli-0.4.1-linux-arm64.tar.gz` | 3.1 MB | [⬇️ Download](https://github.com/redtidev1918/DAKit/releases/download/dakit_cli-v0.4.1/dakit-cli-0.4.1-linux-arm64.tar.gz) |
| Linux · x64 | `dakit-cli-0.4.1-linux-x64.tar.gz` | 3.2 MB | [⬇️ Download](https://github.com/redtidev1918/DAKit/releases/download/dakit_cli-v0.4.1/dakit-cli-0.4.1-linux-x64.tar.gz) |
