  ...
  static DeviationInit parseInit(Object? data) {
    ...
    return DeviationInit(
      ...
      publishedAt: _timestamp(
        deviation['publishedTime'] is String ||
                deviation['publishedTime'] == null
            ? deviation['publishedTime'] as Object?
            : (extended is Map ? extended['publishedTime'] : null),
      ),
      updatedAt: _timestamp(
        deviation['updatedTime'] is String || deviation['updatedTime'] == null
            ? deviation['updatedTime'] as Object?
            : (extended is Map ? extended['updatedTime'] : null),
      ),
    );
  }
